...
export default function Login() {
     ...
     const { setUserRegisterData, userRegisterData, setUserName,
          setLogoUrl, setLogin, setForgotOn, forgotOn } = useContext(allContext)
     const onClicks = () => {
                                        ...
                                        <div className={`${loginTrue ? "" : "hidden"}`}>
                                             ...
                                             <form onSubmit={handleSubmitLogin} className="space-y-5">
                                                  ...
                                                  <div>
                                                       ...
                                                       <a className='text-[14px] mt-4 text-left text-blue-600 cursor-pointer' onClick={e => setForgotOn(true)}>Forgot Password?</a>
